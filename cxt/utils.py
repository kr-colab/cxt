...
def _setup_cxt_model_legacy(model_type: str = "broad"):
    """Legacy stub -- redirects to cxt.checkpoint.load_model."""
    from cxt.checkpoint import load_model
    return load_model(model_type=model_type, device="cpu")
...
def setup_cxt_model(
    ...
    """
    from cxt.checkpoint import load_model
    return load_model(model_type=model_type, device="cpu", force_local=force_local)